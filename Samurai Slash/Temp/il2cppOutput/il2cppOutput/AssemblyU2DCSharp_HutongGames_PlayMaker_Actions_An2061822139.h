...
struct  AnyKey_t2061822139  : public FsmStateAction_t2862378169
{
public:
...
public:
	inline static int32_t get_offset_of_sendEvent_11() { return static_cast<int32_t>(offsetof(AnyKey_t2061822139, ___sendEvent_11)); }
