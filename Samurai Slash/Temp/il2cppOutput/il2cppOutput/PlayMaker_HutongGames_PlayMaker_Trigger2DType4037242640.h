...
struct  Trigger2DType_t4037242640 
{
public:
...
public:
	inline static int32_t get_offset_of_value___1() { return static_cast<int32_t>(offsetof(Trigger2DType_t4037242640, ___value___1)); }
